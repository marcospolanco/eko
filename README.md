...
1. **Two minutes:** Read the axiom above.
...
This submission specifies the governed artifact and its validation contract. It does **not** claim a production runtime, real-world approval, or demonstrated business impact.
...
Details: [`schemas/README.md`](schemas/README.md) · progressive tutorial: [`eko-learning-path.md`](eko-learning-path.md)
